...
u = a.union(b) # u = {1, 2, 3, 5, 8, 13, Входят только уникальные значения
i = a.intersection(b) # i = {8, 2, 5} Находит пересечения
dl = a.difference(b) # dl = {1, 3} Вычетает все значения из множества а которые есть в b
dr = b.difference(a) # dr = {13, 21} Наоборот (что выше)
